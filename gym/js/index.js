(function() {
  ...
  dom = {
    ...
    populateCard: function($el, data) {
      return $el.append('<h3>' + data.name + '</h3>' + '<ul class="player__card__list"><li><span>年龄</span><br/>' + data.dob + ' 岁</li><li><span>身高</span><br/>' + data.height + '</li><li><span>国籍</span><br/>' + data.origin + '</li></ul>' + '<ul class="player__card__list player__card__list--last"><li><span>上场次数</span><br/>' + data.games + '</li><li><span>进球数</span><br/>' + data.goals + '</li></ul>');
    },
